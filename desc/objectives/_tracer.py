...
class ParticleTracer(_Objective):
    ...
    def compute(self, params, constants=None):
        ...
        solution = diffeqsolve(term, solver, t0=t_jax[0], t1=t_jax[-1], dt0=(5e-2)/7500, y0=initial_conds, saveat=saveat, args=self.initial_parameters, stepsize_controller=stepsize_controller)
