...
class ParticleTracer(_Objective):
    ...
    def compute(self, params, constants=None):
        ...
        solution = diffeqsolve(term, solver, t0=t_jax[0], t1=t_jax[-1], dt0=t_jax[1]-t_jax[0], y0=initial_conds, saveat=saveat, args=self.initial_parameters, max_steps=t_jax.size ,stepsize_controller=stepsize_controller)
